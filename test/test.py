...
def TestArchiveWithOptions(options=[]):
    want_trees = {
        ...
        'mixed-paths.zip': {
            ...
            '? (3)': {'md5': 'e6ade0e8b4f62d8d7ea74abd60f18027'},
            '? (4)': {'md5': '3e9c3a7b046474add2da5aa3397c3170'},
            '? (5)': {'md5': '72878fc9a1ae28aef32afff602158d4a'},
            '? (6)': {'md5': 'ebee9acee0ac49c76eb2de67051592c0'},
            '?': {'mode': 'drwxr-xr-x'},
